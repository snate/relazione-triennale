...
\source{\url{http://www.jgalileo.com/wp-content/uploads/sanmarco.jpg}}
\label{fig:logo-smi}%
\end{figure}
...
\begin{figure}[H]%
  \noindent\makebox[\columnwidth][c]{\includegraphics[width=1.5\columnwidth]{immagini/scrum-schema}}%
  \caption{Flusso di sviluppo software in Scrum}%
  \source{\url{http://calvinx.com/wp-content/uploads/2014/05/scrum-overview-mark-hoogveld.jpg}}
...
\begin{figure}%
  \noindent\makebox[\columnwidth][c]{\includegraphics[width=1.3\columnwidth]{immagini/jpa-sprint-viewer}}%
...
\begin{figure}[H]%
  \noindent\makebox[\columnwidth][c]{\includegraphics[width=1.1\columnwidth]{immagini/task-life-cycle}}%
...
\begin{figure}%
  \noindent\makebox[\columnwidth][c]{\includegraphics[width=\columnwidth]{immagini/open-power-foundation}}%
  \caption{Ciclo di vita di un task}%
  \source{\url{http://openpowerfoundation.org/wp-content/uploads/2014/03/infographics-compliance3.png}}
  \label{fig:task-lifecycle}%
\end{figure}
