...
\newglossaryentry{design-pattern}
{
    ...
    text=design pattern,
    sort=design pattern,
    description={\Gloss{best-practice} usata come soluzione per un problema ricorrente di natura progettuale}
}
...
\newglossaryentry{json}
{
    ...
    text=JSON,
    sort=json,
    description={(\emph{JavaScript Object Notation}) Standard usato per trasmettere dati tramite lo scambio di oggetti nei quali le informazioni sono salvate in coppie chiave-valore}
}
...
\newglossaryentry{kpi}
{
    ...
    text=KPI,
    sort=kpi,
    description={(\emph{Key Performance Indicator}) Indicatori che misurano la qualità dei processi}
}
...
\newglossaryentry{markdown}
{
    ...
    text=markdown,
    sort=markdown,
    description={Linguaggio di markup alternativo all'HTML che, partendo da convenzioni esistenti nelle comunicazioni online, è usato per formattare file di testo al fine di favorirne la leggibilità}
}
...
\newglossaryentry{telescoping}
{
    name={Telescoping},
    text=telescoping,
    sort=telescoping,
    description={Fenomeno negativo che si verifica quando una classe offre un numero eccessivo di costruttori. Il \gloss{design-pattern} \textbf{Builder} è uno dei modi per risolvere questo problema, incapsulando la responsabilità di costruzione di oggetti}
}
...
\newglossaryentry{walkthrough}
{
    ...
    text=walkthrough,
    sort=walkthrough,
    description={Attività di verifica che controlla attentamente ogni aspetto del prodotto in esame}
}
