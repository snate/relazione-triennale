...
\addtocategory{web}{site:html5}
\addtocategory{figure}{figure:scrum-overview}
\addtocategory{figure}{figure:smi-logo}
\addtocategory{figure}{figure:open-power}
\addtocategory{figure}{figure:agc}
\addtocategory{figure}{figure:fa-logo}

\defbibheading{opere}{\section*{Riferimenti bibliografici}}
\defbibheading{web}{\section*{Siti Web consultati}}
\defbibheading{figure}{\section*{Figure}}
