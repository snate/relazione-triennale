...
dall'azienda, soffermandosi brevemente a descrivere il prodotto
(JPA\footnote{\emph{Process Architect}}) le cui funzionalità sono state estese
...
\paragraph{} Tale sezione descrive:

\begin{itemize}
\item come l'azienda utilizza il modulo Scrum JPA a supporto dei propri
  processi aziendali;
\item le tecnologie che l'azienda utilizza per lo sviluppo di JPA.
\end{itemize}

\subsubsection{JPA}

\paragraph{} In questa sottosezione viene descritto come l'applicazione JPA
supporta lo sviluppo e la ripartizione del lavoro di un team.
...
\paragraph{} Tale sezione descrive come veniva pianificato il lavoro.
...
\paragraph{} In questa sezione vengono illustrate le parti salienti
dell'attività di stage nel suo complesso.
